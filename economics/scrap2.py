...
def single_page(Url_page,page_id = 1):
    ...
    articleItems = articles.find_all('li' ,{'class':'tlitem clearfix'})
...
for i in range (1 , 3700):
    link = f'https://cafef.vn/timeline/31/trang-{i}.chn'
    links.append(link)
...
parsing_category_pages (number_pages_start = 2000, number_pages_end=3700)
